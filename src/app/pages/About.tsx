    ...
    <div className="bg-background min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn} className="relative">
            ...
            <div className="relative rounded-3xl overflow-hidden border border-black/10 shadow-2xl">
              <img
                src={content.director_photo_url || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2mCijkGTMih5BfvK3XUYBjf6mljaaJ-ICXS8tnagV5KsjlbvD-PfASC4&s=10"}
                alt={content.director_name}
              ...
              <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
                <div>
                  <h3 className="text-2xl font-bold text-white mb-1">{content.director_name}</h3>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <motion.div variants={fadeIn} className="mt-10">
              <img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Signature_of_John_Hancock.svg" alt="Signature" className="h-12 opacity-80 mix-blend-multiply" />
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-24 px-4 md:px-6 bg-background border-y border-black/5 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
          {[
            { icon: Target, title: "Our Mission", text: content.mission_text },
            { icon: Eye, title: "Our Vision", text: content.vision_text },
          ].map((item, i) => (
