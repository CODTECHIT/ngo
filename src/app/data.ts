...
export const SERVICES = [
  { slug: "skill-development", icon: "BookOpen", title: "Skill Development", color: "bg-amber-50", textColor: "text-amber-700", desc: "Vocational training, digital literacy, and livelihood programs empowering individuals to build sustainable futures.", details: "Our skill development centres operate in 14 cities and have trained over 8,200 individuals since 2012. Programs range from basic computer literacy to advanced coding bootcamps and artisan crafts. Each trainee receives placement support and a recognised certification upon completion." },
  { slug: "environment", icon: "Leaf", title: "Environmental Awareness", color: "bg-emerald-50", textColor: "text-emerald-700", desc: "Tree plantation drives, waste management campaigns, and conservation workshops for a greener tomorrow.", details: "We have planted 1.2 million saplings across 9 states, partnered with 80 municipal bodies for waste segregation, and run 340 school-level conservation workshops annually. Our Green Schools Program currently covers 220 government schools." },
  { slug: "women-empowerment", icon: "Users", title: "Women Empowerment", color: "bg-rose-50", textColor: "text-rose-700", desc: "Self-help groups, legal aid, health camps, and entrepreneurship support for women across communities.", details: "3,200 women are active members of our self-help groups across rural and peri-urban areas. We provide micro-finance linkages, legal awareness camps, free health check-ups, and business incubation support for women entrepreneurs." },
  { slug: "community-development", icon: "Globe", title: "Community Development", color: "bg-blue-50", textColor: "text-blue-700", desc: "Infrastructure improvement, sanitation projects, and local governance engagement for stronger communities.", details: "From building village libraries to installing solar street lights, our community projects are co-designed with residents. We have completed 140+ infrastructure projects across 9 states with funding from government schemes and corporate CSR." },
  ...
  { slug: "training-workshops", icon: "Handshake", title: "Training Workshops", color: "bg-orange-50", textColor: "text-orange-700", desc: "Expert-led workshops on health, rights, financial literacy, and sustainable livelihoods.", details: "450+ workshops conducted annually with over 38,000 participants. Topics include personal finance, reproductive health, disaster preparedness, legal rights, and sustainable farming. All workshops are free of charge for participants." },
];
