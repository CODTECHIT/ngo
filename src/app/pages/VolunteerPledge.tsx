...
export const VolunteerPledge: React.FC = () => {
  ...
  useEffect(() => {
    // Fetch live Volunteer count
    api.getVolunteerPledgeCount().then(count => setPledgeCount(count)).catch(() => { });
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
      ...
      const newCertId = generateCertificateId('Volunteer');
    ...
    try {
      ...
      const fallbackId = generateCertificateId('Volunteer');
  ...
  useEffect(() => {
    ...
    bgImg.onload = () => {
      ...
      ctx.fillText('has successfully completed their dedicated volunteer service,', canvas.width / 2, canvas.height * 0.63);
      ctx.fillText('contributing significantly to our community initiatives and social welfare programs.', canvas.width / 2, canvas.height * 0.67);
      ...
      ctx.fillText(dateStr, canvas.width * 0.33, canvas.height * 0.82);
      ...
      signImg.onload = () => {
        ...
        ctx.drawImage(signImg, canvas.width * 0.68 - signWidth / 2, canvas.height * 0.81 - signHeight - 10, signWidth, signHeight);
        
        ctx.font = 'bold italic 30px "Times New Roman", Georgia, serif';
        ctx.fillText('Lion Dr. R. Srinivas', canvas.width * 0.68, canvas.height * 0.81);
        ctx.font = 'bold 18px "Inter", sans-serif';
        ctx.fillText('Director', canvas.width * 0.68, canvas.height * 0.835);
      };
    };
  }, [submittedCert]);
  ...
  const handleShareWhatsApp = () => {
    ...
    const text = encodeURIComponent(`I just took the Volunteer Appreciation for a Drug-Free India and earned my Certificate of Commitment! Take the pledge here: https://ngo-azure-zeta.vercel.app/nasha-mukt-pledge`);
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        {/* Hero Banner */}
        <div className="relative bg-gradient-to-r from-purple-700 via-fuchsia-600 to-purple-800 text-white rounded-3xl p-8 sm:p-12 shadow-2xl overflow-hidden border border-purple-500/30">
          <div className="absolute top-0 right-0 -mt-10 -mr-10 w-64 h-64 bg-fuchsia-400/20 rounded-full blur-3xl pointer-events-none"></div>
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-4 text-center md:text-left max-w-2xl">
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md px-3.5 py-1.5 rounded-full text-xs font-bold text-purple-100 uppercase tracking-widest border border-white/20">
                <Sparkles className="w-4 h-4 text-fuchsia-300" /> Government & NGO Youth Drive
              </div>
              ...
              <p className="text-purple-100 text-sm sm:text-base leading-relaxed">
                We appreciate your valuable time and effort. Enter your details below to download your official <strong>Certificate of Appreciation</strong> for free.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-6 rounded-2xl text-center shrink-0 w-full sm:w-auto shadow-inner">
              <div className="flex items-center justify-center gap-2 text-fuchsia-300 mb-1">
              ...
              <p className="text-xs text-purple-100 mt-1">Youth Pledged Nationwide</p>
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="bg-white dark:bg-slate-800 p-6 rounded-3xl shadow-lg border border-slate-200 dark:border-slate-700">
                <h3 className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2 mb-4">
                  <ShieldCheck className="w-5 h-5 text-purple-500" /> Why Take The Pledge?
                </h3>
              ...
              <div className="bg-gradient-to-br from-purple-500 to-fuchsia-600 text-white p-6 rounded-3xl shadow-lg space-y-3">
                <HeartHandshake className="w-8 h-8 text-purple-200" />
                <h4 className="text-lg font-bold">The Volunteer Affirmation</h4>
                <p className="text-xs text-purple-50 leading-relaxed italic">
              ...
              <div className="text-center p-4 bg-slate-100 dark:bg-slate-800/60 rounded-2xl border border-slate-200 dark:border-slate-700">
                ...
                <Link to="/verify-certificate" className="inline-flex items-center text-xs font-bold text-purple-600 dark:text-purple-400 hover:underline mt-1">
            ...
            <div className="lg:col-span-7 bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-700">
              <div className="mb-6">
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
                  <Award className="w-6 h-6 text-purple-500" /> Delegate Registration Form
                </h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                  />
                </div>
                ...
                {/* Pledge Checkbox */}
                <div className="pt-2">
                  <label className="flex items-start gap-3 p-4 bg-purple-50 dark:bg-purple-950/30 rounded-2xl border border-purple-200 dark:border-purple-900 cursor-pointer">
                    <input
                      type="checkbox"
                      name="pledgeAgreed"
                    ...
                    <span className="text-xs text-slate-800 dark:text-slate-200 leading-relaxed font-medium">
                      I hereby confirm my participation in the volunteer program and pledge to continue my dedicated service for the betterment of society.
                    </span>
                  </label>
                </div>
                ...
                <div className="pt-4">
                  <button
                    ...
                    className="w-full py-3.5 bg-gradient-to-r from-purple-600 to-fuchsia-600 hover:from-purple-700 hover:to-fuchsia-700 text-white font-bold rounded-2xl shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2 text-base"
                  >
          ...
          <div className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-700 text-center space-y-8">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              <button
                ...
                className="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-xl shadow-md transition flex items-center gap-2 text-sm"
              >
            ...
            <div className="pt-4 border-t border-slate-200 dark:border-slate-700 flex items-center justify-center gap-3 text-xs text-slate-500">
              ...
              <span>•</span>
              <Link to={`/verify-certificate?id=${submittedCert.certificate_id}`} className="text-purple-600 dark:text-purple-400 font-bold hover:underline">
                Verify Online
              </Link>
            </div>
          </div>
